...
import com.example.demo.common.annotation.ClearCache;
import com.example.demo.common.annotation.RequiredCache;
import com.example.demo.common.exception.ServiceException;
import com.example.demo.common.vo.Node;
import com.example.demo.dao.SysDeptDao;
...
public class SysDeptServiceImpl implements SysDeptService {
    ...
    public List<Map<String, Object>> findObjects() {
        System.out.println(" class SysCacheAspect 切面执行了");
